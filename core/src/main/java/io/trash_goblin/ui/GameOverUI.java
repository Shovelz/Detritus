...
import io.trash_goblin.screens.GameOverScreen;
...
public class GameOverUI {
    ...
    public GameOverUI(Main game, AssetManager assetManager){
        menuTable = new Table();
        this.assetManager = assetManager;
        assetManager.load("ui/gameOver.png", Texture.class);
        assetManager.finishLoading();
        background = assetManager.get("ui/gameOver.png", Texture.class);


        startButton = new VisTextButton("Restart");
